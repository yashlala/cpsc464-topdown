...
def apply_noise_to_partition_iter(noisifiers, index, part_iter):
    """
    ...
    :param part_iter: iterator of the rows of true table
...
class engine(driver.AbstractDASEngine):
        ...
        for (tname, table) in tables.items():
            ...
            if self.getconfig("seed", default="urandom", section="engine") == "urandom":
                ...
                noisy_table = table.rdd.mapPartitionsWithIndex(
                    lambda index, part_iter: apply_noise_to_partition_iter(self.flat_noisifiers_table(tname), index, part_iter)
                )
    ...
    def create_noise_algorithm_by_name(self, tname: str, varname: str):
        """
    ...
    def print_algorithms_epsilons(self) -> str:
        """
    ...
    def flat_noisifiers_table(self, tname: str) -> List:
        """
        :param tname: Table name
    ...
    def get_number_of_unirand_for_table(self, tname: str) -> float:
        """
    ...
    def elaborate_config(self) -> None:
        pass

    def setup_udf(self) -> None:
        pass

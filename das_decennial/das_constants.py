...
class _DAS_CONSTANTS:
    ...
    # GEODICT
    ###########################################
    PRIM_GEO_S3_PATH = "prim_geo_s3_path"
#    DEFAULT_PRIM_GEO_S3_PATH = "s3://v-s3-das-ite-sourcedata/crosswalks/primgeo_crosswalk_2010tabblk.csv"
    DEFAULT_PRIM_GEO_S3_PATH = "${DAS_S3INPUTS}/crosswalks/primgeo_crosswalk_2010tabblk.csv"
    GEOLEVELS = "geolevels"
    GEODICT = "geodict"
    ...
    COMPUTE_PRIM_ERROR_METRICS = "compute_prim_error_metrics"

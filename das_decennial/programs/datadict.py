...
import programs.constraints.Constraints_DHCH_Ten_3Lev as Constraints_DHCH_Ten_3Lev
import programs.constraints.Constraints_DHCH_FullTenure as Constraints_DHCH_FullTenure
...
def getConstraintsModule(schema_name):
    ...
    constraint_modules = {
        ...
        CC.SCHEMA_DHCH_TEN_3LEV: Constraints_DHCH_Ten_3Lev,
        CC.SCHEMA_DHCH_FULLTENURE: Constraints_DHCH_FullTenure,

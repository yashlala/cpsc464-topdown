...
class ConstraintsCreatorDHCGeneric(querybase_constraints.ConstraintsCreatorwHHGQ):
    ...
    def relgq23_lt17_gt65(self, name):
        """
            Structural zero: No <17 or >65 ages in GQ 106 Military Disciplinary Barracks
        """
    ...
    def relgq31_lt17_gt65(self, name):
        """
            Structural zero: No <17 or >65 ages in GQ 404 Military Treatment Facilities
        """
        self.addToConstraintsDict(name, ("relgq31", CC.AGE_LT17GT65_TOTAL), np.array(0), "=")

    def relgq32_lt3_gt30(self, name):
        """
            Structural zero: No <3 or >30 ages in GQ 405 Residential schools for people with disabilities
        """
        self.addToConstraintsDict(name, ("relgq32", CC.AGE_LT3_GT30_TOTAL), np.array(0), "=")

    def relgq33_lt16_gt65(self, name):
        """
            Structural zero: No <16 or >65 ages in College / University Student Housing
        """
    ...
    def relgq40_lt16_gt75(self, name):
        """
            Structural zero: No <16 or >75 ages in GQ 901 Workers' group living quarters and job corps centers
        """
...
class ConstraintsCreator(ConstraintsCreatorDHCGeneric):
    ...
    def pl94(self, name):
        "Constrain to a previous PL94 run. Just for testing "
        self.checkInvariantPresence(name, ('pl94',))
        self.addToConstraintsDict(name, (CC.HHGQ_8LEV, CC.AGE_VOTINGLEVELS, CC.ATTR_HISP, CC.ATTR_CENRACE), self.invariants["pl94"].astype(int), "=")

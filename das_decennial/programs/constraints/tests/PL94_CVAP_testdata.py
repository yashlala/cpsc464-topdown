...
from programs.constraints.Constraints_PL94_CVAP import ConstraintsCreator
from das_utils import table2hists
from das_constants import CC

schema = SchemaMaker.fromName(CC.SCHEMA_PL94_CVAP)
...
data1 = {
    'data': [   # columns: 'hhgq', 'votingage', 'hispanic', 'cenrace', 'citizen', 'unique unitid' (shape 8,2,2,63,2 + unitUID)

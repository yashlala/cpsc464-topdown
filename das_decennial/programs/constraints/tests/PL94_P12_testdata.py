...
from programs.constraints.Constraints_PL94_P12 import ConstraintsCreator
from das_utils import table2hists
from das_constants import CC

schema = SchemaMaker.fromName(CC.SCHEMA_PL94_P12)
...
data1 = {
    'data': [   # columns: 'hhgq', 'sex', 'agecat', 'hispanic', 'cenrace', 'unique unitid' (shape 8,2,23,2,63 + unit UID)

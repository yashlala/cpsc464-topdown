...
class ConstraintsCreatorPL94Generic(querybase_constraints.ConstraintsCreatorwHHGQ):
    ...
    implemented = ('nurse_nva_0', 'total', 'voting_age', 'hhgq_total_lb', 'hhgq_total_ub', 'hhgq_va_ub', 'hhgq_va_lb')
    ...
    def voting_age(self, name):
        ...
        self.addToConstraintsDict(name, CC.VOTING_TOTAL, self.invariants["va"].astype(int), "=")
    ...
    def hhgq_va_ub(self, name):
        ...
        self.addToConstraintsDict(name, (self.attr_hhgq, CC.ATTR_VOTING), rhs, "le")
    ...
    def hhgq_va_lb(self, name):
        ...
        self.addToConstraintsDict(name, (self.attr_hhgq, CC.ATTR_VOTING), rhs, "ge")

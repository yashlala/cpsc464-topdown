...
# Automatically generated on Tue Jun  1 15:20:15 2021 by C:\cygwin64\home\user007\repos\etl_2020\ctools\schema\table.py
...
class MDF_Person_validator:
    ...
    def validate_pipe_delimited(self,x):
        ...
        if self.is_valid_GQTYPE_PL(fields[9]) == False: return False
        if self.is_valid_VOTING_AGE(fields[10]) == False: return False
        if self.is_valid_CENHISP(fields[11]) == False: return False
        if self.is_valid_CENRACE(fields[12]) == False: return False
        return True
...
class MDF_Unit_validator:
    ...
    def validate_pipe_delimited(self,x):
        ...
        if self.is_valid_HH_STATUS(fields[8]) == False: return False
        return True

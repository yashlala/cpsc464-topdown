...
class Household2010ToMDFUnit2020Recoder(MDF2020Recoder):
    ...
    def recode(self, row: Row, nullfill=False):
        """
        ...
        uncond_recodes = [
            ...
            self.tabblk_recoder,
            self.das_spine_geocode_format_recoder,
        ]
    ...
    @staticmethod
    def schema_type_code_recoder(row: Row):
        """
    ...
    def rtype_hu_recoder(self, row: Row, nullfiller):
        """
    ...
    def gqtype_niu_recoder(self, row: Row, nullfiller):
        """
    ...
    def ten_occupied_recoder(self, row: Row, nullfiller):
        """
    ...
    def vacs_niu_recoder(self, row: Row, nullfiller):
        """
    ...
    def hhsize_recoder(self, row: Row, nullfiller):
        """
    ...
    def hhsex_recoder(self, row: Row, nullfiller):
        """
    ...
    def hht_recoder(self, row: Row, nullfiller):
        """
    ...
    def hht2_recoder(self, row: Row, nullfiller):
        """
    ...
    def cplt_recoder(self, row: Row, nullfiller):
        """
    ...
    def upart_recoder(self, row: Row, nullfiller):
        """
    ...
    def multg_recoder(self, row: Row, nullfiller):
        """
    ...
    def hhldrage_recoder(self, row: Row, nullfiller):
        """
    ...
    def hhspan_recoder(self, row: Row, nullfiller):
        """
    ...
    def hhrace_recoder(self, row: Row, nullfiller):
        """
    ...
    def paoc_recoder(self, row: Row, nullfiller):
        """
    ...
    def p18_recoder(self, row: Row, nullfiller):
        """
    ...
    def p60_recoder(self, row: Row, nullfiller):
        """
    ...
    def p65_recoder(self, row: Row, nullfiller):
        """
    ...
    def p75_recoder(self, row: Row, nullfiller):
        """
    ...
    def pac_recoder(self, row: Row, nullfiller):
        """
...
class H12020MDFHousehold2020Recoder(Household2010ToMDFUnit2020Recoder):
    ...
    def hh_status_recoder(self, row: Row, nullfiller):
        """

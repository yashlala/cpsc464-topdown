...
class DHCPHHGQToMDFPersons2020Recoder(MDF2020Recoder):
    ...
    def relship_recoder(self, row: Row):
        """
    ...
    def live_alone_recoder(self, row: Row):
        """
...
class AnyToMDFPersons2020Recoder(DHCPHHGQToMDFPersons2020Recoder):

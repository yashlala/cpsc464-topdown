from programs.writer.mdf2020writer import MDF2020PersonWriter, MDF2020HouseholdWriter
...
#TODO: Currently overriding many of the recodes. Won't need to if refactored if above attributes are changed to class variables
class IPUMS1940ToMDFPersons2020Recoder(DHCPHHGQToMDFPersons2020Recoder):
    ...
    def enumdist_recoder(self, row: Row):
        """
    ...
    def supdist_recoder(self, row: Row):
        """
    ...
    def cenrace_recoder(self, row: Row):
        """
    ...
    def cenhisp_recoder(self, row: Row):
        """
    ...
    def rtype_recoder(self, row: Row):
        """
    ...
    def gqtype_recoder(self, row: Row):
        """
    ...
    def citizen_recoder(self, row: Row):
        """

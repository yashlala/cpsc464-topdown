#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# This file was automatically generated by spec_scanner.py on Fri Oct 23 12:48:10 2020
# Command line: spec_scanner.py ipums_reader/EXT1940USCB.sas --output_parser ipums_reader/ipums_1940_classes.py

# Automatically generated on Fri Oct 23 12:48:10 2020 by /mnt/users/user007/das-vm-config/das_decennial/das_framework/ctools/schema/table.py
...
class H_validator:
    ...
    def validate_pipe_delimited(self,x):
        ...
        if self.is_valid_RECTYPE(fields[1]) == False: return False
        if self.is_valid_YEAR(fields[2]) == False: return False
        if self.is_valid_DATANUM(fields[3]) == False: return False
        if self.is_valid_SERIAL(fields[4]) == False: return False
        if self.is_valid_NUMPREC(fields[5]) == False: return False
        if self.is_valid_SUBSAMP(fields[6]) == False: return False
        if self.is_valid_HHWT(fields[7]) == False: return False
        if self.is_valid_NUMPERHH(fields[8]) == False: return False
        if self.is_valid_HHTYPE(fields[9]) == False: return False
        if self.is_valid_DWELLING(fields[10]) == False: return False
        if self.is_valid_SLPERNUM(fields[11]) == False: return False
        if self.is_valid_CPI99(fields[12]) == False: return False
        if self.is_valid_REGION(fields[13]) == False: return False
        if self.is_valid_STATEICP(fields[14]) == False: return False
        if self.is_valid_STATEFIP(fields[15]) == False: return False
        if self.is_valid_COUNTY(fields[16]) == False: return False
        if self.is_valid_URBAN(fields[17]) == False: return False
        if self.is_valid_METRO(fields[18]) == False: return False
        if self.is_valid_METAREA(fields[19]) == False: return False
        if self.is_valid_METAREAD(fields[20]) == False: return False
        if self.is_valid_CITY(fields[21]) == False: return False
        if self.is_valid_CITYPOP(fields[22]) == False: return False
        if self.is_valid_SIZEPL(fields[23]) == False: return False
        if self.is_valid_URBPOP(fields[24]) == False: return False
        if self.is_valid_SEA(fields[25]) == False: return False
        if self.is_valid_WARD(fields[26]) == False: return False
        if self.is_valid_CNTRY(fields[27]) == False: return False
        if self.is_valid_GQ(fields[28]) == False: return False
        if self.is_valid_GQTYPE(fields[29]) == False: return False
        if self.is_valid_GQTYPED(fields[30]) == False: return False
        if self.is_valid_GQFUNDS(fields[31]) == False: return False
        if self.is_valid_FARM(fields[32]) == False: return False
        if self.is_valid_OWNERSHP(fields[33]) == False: return False
        if self.is_valid_OWNERSHPD(fields[34]) == False: return False
        if self.is_valid_RENT(fields[35]) == False: return False
        if self.is_valid_VALUEH(fields[36]) == False: return False
        if self.is_valid_NFAMS(fields[37]) == False: return False
        if self.is_valid_NSUBFAM(fields[38]) == False: return False
        if self.is_valid_NCOUPLES(fields[39]) == False: return False
        if self.is_valid_NMOTHERS(fields[40]) == False: return False
        if self.is_valid_NFATHERS(fields[41]) == False: return False
        if self.is_valid_MULTGEN(fields[42]) == False: return False
        if self.is_valid_MULTGEND(fields[43]) == False: return False
        if self.is_valid_ENUMDIST(fields[44]) == False: return False
        if self.is_valid_SUPDIST(fields[45]) == False: return False
        if self.is_valid_RESPOND(fields[46]) == False: return False
        if self.is_valid_SPLIT(fields[47]) == False: return False
        if self.is_valid_SPLITHID(fields[48]) == False: return False
        if self.is_valid_SPLITNUM(fields[49]) == False: return False
        if self.is_valid_SPLIT40(fields[50]) == False: return False
        if self.is_valid_SERIAL40(fields[51]) == False: return False
        if self.is_valid_NUMPREC40(fields[52]) == False: return False
        if self.is_valid_EDMISS(fields[53]) == False: return False
        return True
...
class H:
    ...
    def parse_pipe_delimited(self,line):
        ...
        self.RECTYPE         = fields[0]  # Record type
        self.YEAR            = fields[1]  # Census year
        self.DATANUM         = fields[2]  # Data set number
        self.SERIAL          = fields[3]  # Household serial number
        self.NUMPREC         = fields[4]  # Number of person records following
        self.SUBSAMP         = fields[5]  # Subsample number
        self.HHWT            = fields[6]  # Household weight
        self.NUMPERHH        = fields[7]  # Number of persons in household
        self.HHTYPE          = fields[8]  # Household Type
        self.DWELLING        = fields[9]  # Dwelling serial number
        self.SLPERNUM        = fields[10]  # Sample-line person number
        self.CPI99           = fields[11]  # CPI-U adjustment factor to 1999 dollars
        self.REGION          = fields[12]  # Census region and division
        self.STATEICP        = fields[13]  # State (ICPSR code)
        self.STATEFIP        = fields[14]  # State (FIPS code)
        self.COUNTY          = fields[15]  # County
        self.URBAN           = fields[16]  # Urban/rural status
        self.METRO           = fields[17]  # Metropolitan status
        self.METAREA         = fields[18]  # Metropolitan area [general version]
        self.METAREAD        = fields[19]  # Metropolitan area [detailed version]
        self.CITY            = fields[20]  # City
        self.CITYPOP         = fields[21]  # City population
        self.SIZEPL          = fields[22]  # Size of place
        self.URBPOP          = fields[23]  # Population of urban places
        self.SEA             = fields[24]  # State Economic Area
        self.WARD            = fields[25]  # Ward
        self.CNTRY           = fields[26]  # Country
        self.GQ              = fields[27]  # Group quarters status
        self.GQTYPE          = fields[28]  # Group quarters type [general version]
        self.GQTYPED         = fields[29]  # Group quarters type [detailed version]
        self.GQFUNDS         = fields[30]  # Group quarters funding
        self.FARM            = fields[31]  # Farm status
        self.OWNERSHP        = fields[32]  # Ownership of dwelling (tenure) [general version]
        self.OWNERSHPD       = fields[33]  # Ownership of dwelling (tenure) [detailed version]
        self.RENT            = fields[34]  # Monthly contract rent
        self.VALUEH          = fields[35]  # House value
        self.NFAMS           = fields[36]  # Number of families in household
        self.NSUBFAM         = fields[37]  # Number of subfamilies in household
        self.NCOUPLES        = fields[38]  # Number of couples in household
        self.NMOTHERS        = fields[39]  # Number of mothers in household
        self.NFATHERS        = fields[40]  # Number of fathers in household
        self.MULTGEN         = fields[41]  # Multigenerational household [general version]
        self.MULTGEND        = fields[42]  # Multigenerational household [detailed version]
        self.ENUMDIST        = fields[43]  # Enumeration district
        self.SUPDIST         = fields[44]  # Supervisor's district number
        self.RESPOND         = fields[45]  # Respondent's relationship to household  head
        self.SPLIT           = fields[46]  # Large group quarters that was split up (100% datasets)
        self.SPLITHID        = fields[47]  # Household serial number, before large group quarters were split up (100% datasets)
        self.SPLITNUM        = fields[48]  # Number of person records in household, before large group quarters were split up  (100% datasets)
        self.SPLIT40         = fields[49]  # Large group quarters that was split up, 1940 100%
        self.SERIAL40        = fields[50]  # Household serial number, before large group quarters were split up, 1940 100%
        self.NUMPREC40       = fields[51]  # Number of person records in household, before large group quarters were split up, 1940 100%
        self.EDMISS          = fields[52]  # Identifies households in missing data enumeration districts

    def parse_column_specified(self,line):
        self.RECTYPE         = line[0:1] # Record type
        self.YEAR            = line[1:5] # Census year
        self.DATANUM         = line[5:7] # Data set number
        self.SERIAL          = line[7:15] # Household serial number
        self.NUMPREC         = line[15:17] # Number of person records following
        self.SUBSAMP         = line[17:19] # Subsample number
        self.HHWT            = line[19:29] # Household weight
        self.NUMPERHH        = line[29:33] # Number of persons in household
        self.HHTYPE          = line[33:34] # Household Type
        self.DWELLING        = line[34:42] # Dwelling serial number
        self.SLPERNUM        = line[42:44] # Sample-line person number
        self.CPI99           = line[44:49] # CPI-U adjustment factor to 1999 dollars
        self.REGION          = line[49:51] # Census region and division
        self.STATEICP        = line[51:53] # State (ICPSR code)
        self.STATEFIP        = line[53:55] # State (FIPS code)
        self.COUNTY          = line[55:59] # County
        self.URBAN           = line[59:60] # Urban/rural status
        self.METRO           = line[60:61] # Metropolitan status
        self.METAREA         = line[61:64] # Metropolitan area [general version]
        self.METAREAD        = line[64:68] # Metropolitan area [detailed version]
        self.CITY            = line[68:72] # City
        self.CITYPOP         = line[72:77] # City population
        self.SIZEPL          = line[77:79] # Size of place
        self.URBPOP          = line[79:84] # Population of urban places
        self.SEA             = line[84:87] # State Economic Area
        self.WARD            = line[87:90] # Ward
        self.CNTRY           = line[90:93] # Country
        self.GQ              = line[93:94] # Group quarters status
        self.GQTYPE          = line[94:95] # Group quarters type [general version]
        self.GQTYPED         = line[95:98] # Group quarters type [detailed version]
        self.GQFUNDS         = line[98:100] # Group quarters funding
        self.FARM            = line[100:101] # Farm status
        self.OWNERSHP        = line[101:102] # Ownership of dwelling (tenure) [general version]
        self.OWNERSHPD       = line[102:104] # Ownership of dwelling (tenure) [detailed version]
        self.RENT            = line[104:108] # Monthly contract rent
        self.VALUEH          = line[108:115] # House value
        self.NFAMS           = line[115:117] # Number of families in household
        self.NSUBFAM         = line[117:118] # Number of subfamilies in household
        self.NCOUPLES        = line[118:119] # Number of couples in household
        self.NMOTHERS        = line[119:120] # Number of mothers in household
        self.NFATHERS        = line[120:121] # Number of fathers in household
        self.MULTGEN         = line[121:122] # Multigenerational household [general version]
        self.MULTGEND        = line[122:124] # Multigenerational household [detailed version]
        self.ENUMDIST        = line[124:128] # Enumeration district
        self.SUPDIST         = line[128:131] # Supervisor's district number
        self.RESPOND         = line[131:132] # Respondent's relationship to household  head
        self.SPLIT           = line[132:133] # Large group quarters that was split up (100% datasets)
        self.SPLITHID        = line[133:141] # Household serial number, before large group quarters were split up (100% datasets)
        self.SPLITNUM        = line[141:145] # Number of person records in household, before large group quarters were split up  (100% datasets)
        self.SPLIT40         = line[145:146] # Large group quarters that was split up, 1940 100%
        self.SERIAL40        = line[146:154] # Household serial number, before large group quarters were split up, 1940 100%
        self.NUMPREC40       = line[154:158] # Number of person records in household, before large group quarters were split up, 1940 100%
        self.EDMISS          = line[158:159] # Identifies households in missing data enumeration districts
...
class P_validator:
    ...
    def validate_pipe_delimited(self,x):
        ...
        if self.is_valid_DATANUM(fields[3]) == False: return False
        if self.is_valid_SERIAL(fields[4]) == False: return False
        if self.is_valid_PERNUM(fields[5]) == False: return False
        if self.is_valid_PERWT(fields[6]) == False: return False
        if self.is_valid_SLWT(fields[7]) == False: return False
        if self.is_valid_SLREC(fields[8]) == False: return False
        if self.is_valid_RESPONDT(fields[9]) == False: return False
        if self.is_valid_FAMUNIT(fields[10]) == False: return False
        if self.is_valid_FAMSIZE(fields[11]) == False: return False
        if self.is_valid_SUBFAM(fields[12]) == False: return False
        if self.is_valid_SFTYPE(fields[13]) == False: return False
        if self.is_valid_SFRELATE(fields[14]) == False: return False
        if self.is_valid_MOMLOC(fields[15]) == False: return False
        if self.is_valid_STEPMOM(fields[16]) == False: return False
        if self.is_valid_MOMRULE_HIST(fields[17]) == False: return False
        if self.is_valid_POPLOC(fields[18]) == False: return False
        if self.is_valid_STEPPOP(fields[19]) == False: return False
        if self.is_valid_POPRULE_HIST(fields[20]) == False: return False
        if self.is_valid_SPLOC(fields[21]) == False: return False
        if self.is_valid_SPRULE_HIST(fields[22]) == False: return False
        if self.is_valid_NCHILD(fields[23]) == False: return False
        if self.is_valid_NCHLT5(fields[24]) == False: return False
        if self.is_valid_NSIBS(fields[25]) == False: return False
        if self.is_valid_ELDCH(fields[26]) == False: return False
        if self.is_valid_YNGCH(fields[27]) == False: return False
        if self.is_valid_RELATE(fields[28]) == False: return False
        if self.is_valid_RELATED(fields[29]) == False: return False
        if self.is_valid_SEX(fields[30]) == False: return False
        if self.is_valid_AGE(fields[31]) == False: return False
        if self.is_valid_AGEMONTH(fields[32]) == False: return False
        if self.is_valid_MARST(fields[33]) == False: return False
        if self.is_valid_MARRNO(fields[34]) == False: return False
        if self.is_valid_AGEMARR(fields[35]) == False: return False
        if self.is_valid_CHBORN(fields[36]) == False: return False
        if self.is_valid_RACE(fields[37]) == False: return False
        if self.is_valid_RACED(fields[38]) == False: return False
        if self.is_valid_HISPAN(fields[39]) == False: return False
        if self.is_valid_HISPAND(fields[40]) == False: return False
        if self.is_valid_BPL(fields[41]) == False: return False
        if self.is_valid_BPLD(fields[42]) == False: return False
        if self.is_valid_MBPL(fields[43]) == False: return False
        if self.is_valid_MBPLD(fields[44]) == False: return False
        if self.is_valid_FBPL(fields[45]) == False: return False
        if self.is_valid_FBPLD(fields[46]) == False: return False
        if self.is_valid_NATIVITY(fields[47]) == False: return False
        if self.is_valid_CITIZEN(fields[48]) == False: return False
        if self.is_valid_MTONGUE(fields[49]) == False: return False
        if self.is_valid_MTONGUED(fields[50]) == False: return False
        if self.is_valid_SPANNAME(fields[51]) == False: return False
        if self.is_valid_HISPRULE(fields[52]) == False: return False
        if self.is_valid_SCHOOL(fields[53]) == False: return False
        if self.is_valid_HIGRADE(fields[54]) == False: return False
        if self.is_valid_HIGRADED(fields[55]) == False: return False
        if self.is_valid_EDUC(fields[56]) == False: return False
        if self.is_valid_EDUCD(fields[57]) == False: return False
        if self.is_valid_EMPSTAT(fields[58]) == False: return False
        if self.is_valid_EMPSTATD(fields[59]) == False: return False
        if self.is_valid_LABFORCE(fields[60]) == False: return False
        if self.is_valid_OCC(fields[61]) == False: return False
        if self.is_valid_OCC1950(fields[62]) == False: return False
        if self.is_valid_IND(fields[63]) == False: return False
        if self.is_valid_IND1950(fields[64]) == False: return False
        if self.is_valid_CLASSWKR(fields[65]) == False: return False
        if self.is_valid_CLASSWKRD(fields[66]) == False: return False
        if self.is_valid_WKSWORK1(fields[67]) == False: return False
        if self.is_valid_WKSWORK2(fields[68]) == False: return False
        if self.is_valid_HRSWORK1(fields[69]) == False: return False
        if self.is_valid_HRSWORK2(fields[70]) == False: return False
        if self.is_valid_DURUNEMP(fields[71]) == False: return False
        if self.is_valid_UOCC(fields[72]) == False: return False
        if self.is_valid_UOCC95(fields[73]) == False: return False
        if self.is_valid_UIND(fields[74]) == False: return False
        if self.is_valid_UCLASSWK(fields[75]) == False: return False
        if self.is_valid_INCWAGE(fields[76]) == False: return False
        if self.is_valid_INCNONWG(fields[77]) == False: return False
        if self.is_valid_OCCSCORE(fields[78]) == False: return False
        if self.is_valid_SEI(fields[79]) == False: return False
        if self.is_valid_PRESGL(fields[80]) == False: return False
        if self.is_valid_ERSCOR50(fields[81]) == False: return False
        if self.is_valid_EDSCOR50(fields[82]) == False: return False
        if self.is_valid_NPBOSS50(fields[83]) == False: return False
        if self.is_valid_MIGRATE5(fields[84]) == False: return False
        if self.is_valid_MIGRATE5D(fields[85]) == False: return False
        if self.is_valid_MIGPLAC5(fields[86]) == False: return False
        if self.is_valid_MIGMET5(fields[87]) == False: return False
        if self.is_valid_MIGTYPE5(fields[88]) == False: return False
        if self.is_valid_MIGCITY5(fields[89]) == False: return False
        if self.is_valid_MIGSEA5(fields[90]) == False: return False
        if self.is_valid_SAMEPLAC(fields[91]) == False: return False
        if self.is_valid_SAMESEA5(fields[92]) == False: return False
        if self.is_valid_MIGCOUNTY(fields[93]) == False: return False
        if self.is_valid_VETSTAT(fields[94]) == False: return False
        if self.is_valid_VETSTATD(fields[95]) == False: return False
        if self.is_valid_VET1940(fields[96]) == False: return False
        if self.is_valid_VETWWI(fields[97]) == False: return False
        if self.is_valid_VETPER(fields[98]) == False: return False
        if self.is_valid_VETCHILD(fields[99]) == False: return False
        if self.is_valid_HISTID(fields[100]) == False: return False
        if self.is_valid_SURSIM(fields[101]) == False: return False
        if self.is_valid_SSENROLL(fields[102]) == False: return False
        return True
...
class P:
    ...
    def parse_pipe_delimited(self,line):
        ...
        self.DATANUM         = fields[2]  # Data set number
        self.SERIAL          = fields[3]  # Household serial number
        self.PERNUM          = fields[4]  # Person number in sample unit
        self.PERWT           = fields[5]  # Person weight
        self.SLWT            = fields[6]  # Sample-line weight
        self.SLREC           = fields[7]  # Sample-line person identifier
        self.RESPONDT        = fields[8]  # Respondent indicator
        self.FAMUNIT         = fields[9]  # Family unit membership
        self.FAMSIZE         = fields[10]  # Number of own family members in household
        self.SUBFAM          = fields[11]  # Subfamily membership
        self.SFTYPE          = fields[12]  # Subfamily type
        self.SFRELATE        = fields[13]  # Relationship within subfamily
        self.MOMLOC          = fields[14]  # Mother's location in the household
        self.STEPMOM         = fields[15]  # Probable step/adopted mother
        self.MOMRULE_HIST    = fields[16]  #
        self.POPLOC          = fields[17]  # Father's location in the household
        self.STEPPOP         = fields[18]  # Probable step/adopted father
        self.POPRULE_HIST    = fields[19]  #
        self.SPLOC           = fields[20]  # Spouse's location in household
        self.SPRULE_HIST     = fields[21]  #
        self.NCHILD          = fields[22]  # Number of own children in the household
        self.NCHLT5          = fields[23]  # Number of own children under age 5 in household
        self.NSIBS           = fields[24]  # Number of own siblings in household
        self.ELDCH           = fields[25]  # Age of eldest own child in household
        self.YNGCH           = fields[26]  # Age of youngest own child in household
        self.RELATE          = fields[27]  # Relationship to household head [general version]
        self.RELATED         = fields[28]  # Relationship to household head [detailed version]
        self.SEX             = fields[29]  # Sex
        self.AGE             = fields[30]  # Age
        self.AGEMONTH        = fields[31]  # Age in months
        self.MARST           = fields[32]  # Marital status
        self.MARRNO          = fields[33]  # Times married
        self.AGEMARR         = fields[34]  # Age at first marriage
        self.CHBORN          = fields[35]  # Children ever born
        self.RACE            = fields[36]  # Race [general version]
        self.RACED           = fields[37]  # Race [detailed version]
        self.HISPAN          = fields[38]  # Hispanic origin [general version]
        self.HISPAND         = fields[39]  # Hispanic origin [detailed version]
        self.BPL             = fields[40]  # Birthplace [general version]
        self.BPLD            = fields[41]  # Birthplace [detailed version]
        self.MBPL            = fields[42]  # Mother's birthplace [general version]
        self.MBPLD           = fields[43]  # Mother's birthplace [detailed version]
        self.FBPL            = fields[44]  # Father's birthplace [general version]
        self.FBPLD           = fields[45]  # Father's birthplace [detailed version]
        self.NATIVITY        = fields[46]  # Foreign birthplace or parentage
        self.CITIZEN         = fields[47]  # Citizenship status
        self.MTONGUE         = fields[48]  # Mother tongue [general version]
        self.MTONGUED        = fields[49]  # Mother tongue [detailed version]
        self.SPANNAME        = fields[50]  # Spanish surname
        self.HISPRULE        = fields[51]  # Hispanic origin rule
        self.SCHOOL          = fields[52]  # School attendance
        self.HIGRADE         = fields[53]  # Highest grade of schooling [general version]
        self.HIGRADED        = fields[54]  # Highest grade of schooling [detailed version]
        self.EDUC            = fields[55]  # Educational attainment [general version]
        self.EDUCD           = fields[56]  # Educational attainment [detailed version]
        self.EMPSTAT         = fields[57]  # Employment status [general version]
        self.EMPSTATD        = fields[58]  # Employment status [detailed version]
        self.LABFORCE        = fields[59]  # Labor force status
        self.OCC             = fields[60]  # Occupation
        self.OCC1950         = fields[61]  # Occupation, 1950 basis
        self.IND             = fields[62]  # Industry
        self.IND1950         = fields[63]  # Industry, 1950 basis
        self.CLASSWKR        = fields[64]  # Class of worker [general version]
        self.CLASSWKRD       = fields[65]  # Class of worker [detailed version]
        self.WKSWORK1        = fields[66]  # Weeks worked last year
        self.WKSWORK2        = fields[67]  # Weeks worked last year, intervalled
        self.HRSWORK1        = fields[68]  # Hours worked last week
        self.HRSWORK2        = fields[69]  # Hours worked last week, intervalled
        self.DURUNEMP        = fields[70]  # Continuous weeks unemployed
        self.UOCC            = fields[71]  # Usual occupation
        self.UOCC95          = fields[72]  # Usual occupation, 1950 classification
        self.UIND            = fields[73]  # Usual industry
        self.UCLASSWK        = fields[74]  # Usual class of worker
        self.INCWAGE         = fields[75]  # Wage and salary income
        self.INCNONWG        = fields[76]  # Had non-wage/salary income over $50
        self.OCCSCORE        = fields[77]  # Occupational income score
        self.SEI             = fields[78]  # Duncan Socioeconomic Index
        self.PRESGL          = fields[79]  # Occupational prestige score, Siegel
        self.ERSCOR50        = fields[80]  # Occupational earnings score, 1950 basis
        self.EDSCOR50        = fields[81]  # Occupational education score, 1950 basis
        self.NPBOSS50        = fields[82]  # Nam-Powers-Boyd occupational status score, 1950 basis
        self.MIGRATE5        = fields[83]  # Migration status, 5 years [general version]
        self.MIGRATE5D       = fields[84]  # Migration status, 5 years [detailed version]
        self.MIGPLAC5        = fields[85]  # State or country of residence 5 years ago
        self.MIGMET5         = fields[86]  # Metropolitan area of residence 5 years ago
        self.MIGTYPE5        = fields[87]  # Metropolitan status 5 years ago
        self.MIGCITY5        = fields[88]  # City of residence 5 years ago
        self.MIGSEA5         = fields[89]  # SEA of residence 5 years ago
        self.SAMEPLAC        = fields[90]  # Lived same incorporated place 5 years ago
        self.SAMESEA5        = fields[91]  # Lived same SEA 5 years ago
        self.MIGCOUNTY       = fields[92]  # County of residence 5 years ago
        self.VETSTAT         = fields[93]  # Veteran status [general version]
        self.VETSTATD        = fields[94]  # Veteran status [detailed version]
        self.VET1940         = fields[95]  # Veteran status, 1940
        self.VETWWI          = fields[96]  # Veteran, served during WWI era
        self.VETPER          = fields[97]  # Veteran period of service, 1940
        self.VETCHILD        = fields[98]  # Mortality status of child's veteran father
        self.HISTID          = fields[99]  # Consistent historical data person identifier
        self.SURSIM          = fields[100]  # Surname similarity
        self.SSENROLL        = fields[101]  # Social Security enrollment
    ...
    def parse_column_specified(self,line):
        ...
        self.DATANUM         = line[5:7] # Data set number
        self.SERIAL          = line[7:15] # Household serial number
        self.PERNUM          = line[15:19] # Person number in sample unit
        self.PERWT           = line[19:29] # Person weight
        self.SLWT            = line[29:39] # Sample-line weight
        self.SLREC           = line[39:40] # Sample-line person identifier
        self.RESPONDT        = line[40:41] # Respondent indicator
        self.FAMUNIT         = line[41:43] # Family unit membership
        self.FAMSIZE         = line[43:45] # Number of own family members in household
        self.SUBFAM          = line[45:46] # Subfamily membership
        self.SFTYPE          = line[46:47] # Subfamily type
        self.SFRELATE        = line[47:48] # Relationship within subfamily
        self.MOMLOC          = line[48:50] # Mother's location in the household
        self.STEPMOM         = line[50:51] # Probable step/adopted mother
        self.MOMRULE_HIST    = line[51:52] #
        self.POPLOC          = line[52:54] # Father's location in the household
        self.STEPPOP         = line[54:55] # Probable step/adopted father
        self.POPRULE_HIST    = line[55:56] #
        self.SPLOC           = line[56:58] # Spouse's location in household
        self.SPRULE_HIST     = line[58:59] #
        self.NCHILD          = line[59:60] # Number of own children in the household
        self.NCHLT5          = line[60:61] # Number of own children under age 5 in household
        self.NSIBS           = line[61:62] # Number of own siblings in household
        self.ELDCH           = line[62:64] # Age of eldest own child in household
        self.YNGCH           = line[64:66] # Age of youngest own child in household
        self.RELATE          = line[66:68] # Relationship to household head [general version]
        self.RELATED         = line[68:72] # Relationship to household head [detailed version]
        self.SEX             = line[72:73] # Sex
        self.AGE             = line[73:76] # Age
        self.AGEMONTH        = line[76:78] # Age in months
        self.MARST           = line[78:79] # Marital status
        self.MARRNO          = line[79:80] # Times married
        self.AGEMARR         = line[80:82] # Age at first marriage
        self.CHBORN          = line[82:84] # Children ever born
        self.RACE            = line[84:85] # Race [general version]
        self.RACED           = line[85:88] # Race [detailed version]
        self.HISPAN          = line[88:89] # Hispanic origin [general version]
        self.HISPAND         = line[89:92] # Hispanic origin [detailed version]
        self.BPL             = line[92:95] # Birthplace [general version]
        self.BPLD            = line[95:100] # Birthplace [detailed version]
        self.MBPL            = line[100:103] # Mother's birthplace [general version]
        self.MBPLD           = line[103:108] # Mother's birthplace [detailed version]
        self.FBPL            = line[108:111] # Father's birthplace [general version]
        self.FBPLD           = line[111:116] # Father's birthplace [detailed version]
        self.NATIVITY        = line[116:117] # Foreign birthplace or parentage
        self.CITIZEN         = line[117:118] # Citizenship status
        self.MTONGUE         = line[118:120] # Mother tongue [general version]
        self.MTONGUED        = line[120:124] # Mother tongue [detailed version]
        self.SPANNAME        = line[124:125] # Spanish surname
        self.HISPRULE        = line[125:126] # Hispanic origin rule
        self.SCHOOL          = line[126:127] # School attendance
        self.HIGRADE         = line[127:129] # Highest grade of schooling [general version]
        self.HIGRADED        = line[129:132] # Highest grade of schooling [detailed version]
        self.EDUC            = line[132:134] # Educational attainment [general version]
        self.EDUCD           = line[134:137] # Educational attainment [detailed version]
        self.EMPSTAT         = line[137:138] # Employment status [general version]
        self.EMPSTATD        = line[138:140] # Employment status [detailed version]
        self.LABFORCE        = line[140:141] # Labor force status
        self.OCC             = line[141:145] # Occupation
        self.OCC1950         = line[145:148] # Occupation, 1950 basis
        self.IND             = line[148:152] # Industry
        self.IND1950         = line[152:155] # Industry, 1950 basis
        self.CLASSWKR        = line[155:156] # Class of worker [general version]
        self.CLASSWKRD       = line[156:158] # Class of worker [detailed version]
        self.WKSWORK1        = line[158:160] # Weeks worked last year
        self.WKSWORK2        = line[160:161] # Weeks worked last year, intervalled
        self.HRSWORK1        = line[161:163] # Hours worked last week
        self.HRSWORK2        = line[163:164] # Hours worked last week, intervalled
        self.DURUNEMP        = line[164:167] # Continuous weeks unemployed
        self.UOCC            = line[167:170] # Usual occupation
        self.UOCC95          = line[170:173] # Usual occupation, 1950 classification
        self.UIND            = line[173:176] # Usual industry
        self.UCLASSWK        = line[176:177] # Usual class of worker
        self.INCWAGE         = line[177:183] # Wage and salary income
        self.INCNONWG        = line[183:184] # Had non-wage/salary income over $50
        self.OCCSCORE        = line[184:186] # Occupational income score
        self.SEI             = line[186:188] # Duncan Socioeconomic Index
        self.PRESGL          = line[188:191] # Occupational prestige score, Siegel
        self.ERSCOR50        = line[191:195] # Occupational earnings score, 1950 basis
        self.EDSCOR50        = line[195:199] # Occupational education score, 1950 basis
        self.NPBOSS50        = line[199:203] # Nam-Powers-Boyd occupational status score, 1950 basis
        self.MIGRATE5        = line[203:204] # Migration status, 5 years [general version]
        self.MIGRATE5D       = line[204:206] # Migration status, 5 years [detailed version]
        self.MIGPLAC5        = line[206:209] # State or country of residence 5 years ago
        self.MIGMET5         = line[209:213] # Metropolitan area of residence 5 years ago
        self.MIGTYPE5        = line[213:214] # Metropolitan status 5 years ago
        self.MIGCITY5        = line[214:218] # City of residence 5 years ago
        self.MIGSEA5         = line[218:221] # SEA of residence 5 years ago
        self.SAMEPLAC        = line[221:222] # Lived same incorporated place 5 years ago
        self.SAMESEA5        = line[222:223] # Lived same SEA 5 years ago
        self.MIGCOUNTY       = line[223:227] # County of residence 5 years ago
        self.VETSTAT         = line[227:228] # Veteran status [general version]
        self.VETSTATD        = line[228:230] # Veteran status [detailed version]
        self.VET1940         = line[230:231] # Veteran status, 1940
        self.VETWWI          = line[231:232] # Veteran, served during WWI era
        self.VETPER          = line[232:233] # Veteran period of service, 1940
        self.VETCHILD        = line[233:234] # Mortality status of child's veteran father
        self.HISTID          = line[234:270] # Consistent historical data person identifier
        self.SURSIM          = line[270:272] # Surname similarity
        self.SSENROLL        = line[272:273] # Social Security enrollment

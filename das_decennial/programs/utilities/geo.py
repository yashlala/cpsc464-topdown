class GeoHierarchy:
    def __init__(self, geocode_length: int, geonames, geoprefix_sizes):
    ...
    def getLevel(self, geocode: str) -> int:
    ...
    def getParentName(self, level_name: str) -> str:
    ...
    def getParentGeocode(self, childgeo: str) -> str:

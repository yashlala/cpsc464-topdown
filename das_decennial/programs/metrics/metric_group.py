...
class MetricGroup():
    ...
    def __init__(self, emdict: Dict) -> None:
        """
    ...
    def getResultsAsDict(self) -> Dict:
        return self.results
...
class Resma():
    ...
    def subset(self, geolevels: List[str] = None, aggtypes: List[str] = None, metrics: List = None):
    ...
    def __splitArray(self, array: np.ndarray, axis):
        splits = []

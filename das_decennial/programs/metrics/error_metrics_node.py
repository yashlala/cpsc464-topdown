...
class ErrorMetricsNode():
    ...
    """
    def __init__(self, geo_node: GeounitNode) -> None:
        """
    ...
    def calculateErrorMetrics(self, metric_keys: List):
    ...
    def updateCompPair(self, new_pair: List[str]):
    ...
    def getErrorMetricKeys(self) -> List:
        return list(self.error_metric_fxn_dict.keys())

    def divideMetricsBy(self, n: float):
    ...
    def geoCount(self) -> int:
        return 1

    def L1_cell(self) -> np.ndarray:
        """
    ...
    def L1_geounit(self) -> np.ndarray:
        """
    ...
    def avgL1_geounit(self) -> np.ndarray:
        """
    ...
    def L2_geounit(self) -> np.ndarray:
        """
    ...
    def avgL2_geounit(self) -> np.ndarray:
        """
    ...
    def relL1_cell(self, constant: float = 10.0) -> np.ndarray:
        """
    ...
    def relL1_geounit(self, constant: float = 10.0) -> np.ndarray:
        """
    ...
    def relL2_geounit(self, constant: float = 10.0) -> np.ndarray:
        """
    ...
    def LInf_geounit(self) -> np.ndarray:
        """
    ...
    def avgLInf_geounit(self) -> np.ndarray:
        """
    ...
    def tvd_geounit(self) -> np.ndarray:
        """
    ...
    def tot_pop_geounit(self) -> np.ndarray:
        """
    ...
    def sparsity_geounit(self) -> np.ndarray:
        """
    ...
    def true_sparsity_geounit(self) -> np.ndarray:
        """
        Calculates the sparsity
        Outputs:
        """
    ...
    def L1_GQxVA_marg(self) -> np.ndarray:
        """
    ...
    def syn_GQxVA_marg(self) -> np.ndarray:
        """
        Calculates the marginalized GQxVA variables
        Assumes (gq, va, ethnicity, race)
        """
    ...
    def GQxVA_marg(self) -> List[np.ndarray]:
    ...
    def Cenrace_marg(self) -> List[np.ndarray]:
        raw_dense = self.comp1.toDense()

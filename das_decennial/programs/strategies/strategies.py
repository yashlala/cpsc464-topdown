...
class TestStrategy(PL94Strategy, StateLevelStrategy):
    ...
    def make(self, levels):
        ...
        test_strategy.update({
            ...
            CC.DPQUERIES + "default": (
                ...
                "detailed"),
            CC.QUERIESPROP + "default": (tuple(Fr(num, denom) for num in (204, 204, 204, 154, 154, 104))),
            # CC.DPQUERIES: {},
            # CC.QUERIESPROP: {},
            # CC.UNITDPQUERIES: {},
            # CC.UNITQUERIESPROP: {},
        ...
        test_strategy[CC.QUERIESPROP][CC.GEOLEVEL_COUNTY]      = tuple(Fr(num, denom) for num in (104, 304, 204, 154, 154, 104))
        test_strategy[CC.QUERIESPROP][CC.GEOLEVEL_TRACT]       = tuple(Fr(num, denom) for num in ( 54, 354, 204, 154, 154, 104))
        test_strategy[CC.QUERIESPROP][CC.GEOLEVEL_BLOCK_GROUP] = tuple(Fr(num, denom) for num in ( 14, 394, 204, 154, 154, 104))
        test_strategy[CC.QUERIESPROP][CC.GEOLEVEL_BLOCK]       = tuple(Fr(num, denom) for num in (394,  14, 204, 154, 154, 104))
        test_strategy[CC.GEOLEVELS] = levels2make
...
class DecompTestStrategy(PL94Strategy):
    @staticmethod
    def make(levels):
        test_strategy = defaultdict(lambda: defaultdict(dict))  # So as to avoid having to specify empty dicts and defaultdicts
        test_strategy.update({
            CC.GEODICT_GEOLEVELS: levels,
            CC.DPQUERIES + "default": ("total", "hhgq", "hhgq * hispanic * votingage", "numraces * hhgq * hispanic * votingage", "detailed"),
            CC.QUERIESPROP + "default": (tuple(Fr(num, 100) for num in (20, 20, 20, 20, 20))),
        })
        ...
        test_strategy[CC.QUERIESPROP][CC.GEOLEVEL_BLOCK]       = tuple(Fr(num, 100) for num in (39,  1, 20, 20, 20))
        return test_strategy


class SingleStateDecompTestStrategyRegularOrdering:
    @staticmethod
    def make(levels):
        ordering = {
...
class DetailedOnly(USLevelStrategy):
    ...
    @staticmethod
    def make(levels):
        test_strategy = defaultdict(lambda: defaultdict(tuple))  # So as to avoid having to specify empty dicts and defaultdicts
        test_strategy.update({
            CC.GEODICT_GEOLEVELS: levels,
            CC.DPQUERIES + "default": (
                "detailed",),
...
class StrategySelector:
    strategies = {
        ...
        'decomp_test_strategy': DecompTestStrategy,
        ...
        'DHCH_test_strategy': dhch_strategies.TestStrategy,
        'DHCH_test_strategy_full_tenure': dhch_strategies.TestStrategyFullTenure,
        'decomp_test_strategy_dhch': dhch_strategies.DecompTestStrategyDHCH,
        'DHCP_test_strategy': dhcp_strategies.TestStrategy,
        'decomp_test_strategy_dhcp': dhcp_strategies.DecompTestStrategyDHCP,

        'test_strategy_dhch_20220217_OmitRelative_PR': dhch_strategies.DecompTestStrategyDHCH_20220217_omit_with_relative_add_05_PR,
        'test_strategy_dhch_20220217_OmitRelative': dhch_strategies.DecompTestStrategyDHCH_20220217_omit_with_relative_add_05,
        'test_strategy_dhcp_20220310': dhcp_strategies.DecompTestStrategyDHCP_20220310,
        'test_strategy_dhch_20220323_pt1': dhch_strategies.DecompTestStrategyDHCH_20220323_pt1,
        'test_strategy_dhch_20220323_PR_pt1': dhch_strategies.DecompTestStrategyDHCH_20220323_PR_pt1,
        'test_strategy_dhch_20220323_pt2': dhch_strategies.DecompTestStrategyDHCH_20220323_pt2,
        'test_strategy_dhch_20220323_PR_pt2': dhch_strategies.DecompTestStrategyDHCH_20220323_PR_pt2,
        'test_strategy_dhch_20220323_pt3': dhch_strategies.DecompTestStrategyDHCH_20220323_pt3,
        'test_strategy_dhch_20220323_PR_pt3': dhch_strategies.DecompTestStrategyDHCH_20220323_PR_pt3,
        'test_strategy_dhcp_20220413': dhcp_strategies.DecompTestStrategyDHCP_20220413,
        'test_strategy_dhcp_20220511': dhcp_strategies.DecompTestStrategyDHCP_20220511,
        'test_strategy_dhcp_20220518': dhcp_strategies.DecompTestStrategyDHCP_20220518,
        'test_strategy_dhcp_20220811_exp_21_1': dhcp_strategies.DecompTestStrategyDHCP_20220811_exp_21_1,
        'test_strategy_dhcp_20220811_exp_21_2_PR': dhcp_strategies.DecompTestStrategyDHCP_20220811_exp_21_2_PR,
        'test_strategy_dhcp_20220811_exp_21_2_US': dhcp_strategies.DecompTestStrategyDHCP_20220811_exp_21_2_US,
        'test_strategy_dhch_20220520_PR': dhch_strategies.DecompTestStrategyDHCH_20220520_PR_pt3,
        'test_strategy_dhch_20220520': dhch_strategies.DecompTestStrategyDHCH_20220520_pt3,
        'test_strategy_dhch_20220613_PR': dhch_strategies.DecompTestStrategyDHCH_20220613_PR_pt3,
        'test_strategy_dhch_20220613': dhch_strategies.DecompTestStrategyDHCH_20220613_pt3,
        'test_strategy_dhch_20220623_PR': dhch_strategies.DecompTestStrategyDHCH_20220623_PR,
        'test_strategy_dhch_20220623': dhch_strategies.DecompTestStrategyDHCH_20220623,
        'test_strategy_dhch_20220615_PR': dhch_strategies.DecompTestStrategyDHCH_20220615_PR,
        'test_strategy_dhch_20220615': dhch_strategies.DecompTestStrategyDHCH_20220615,
        'test_strategy_dhch_20220713_PR': dhch_strategies.DecompTestStrategyDHCH_20220713_PR,
        'test_strategy_dhch_20220713': dhch_strategies.DecompTestStrategyDHCH_20220713,

        'test_strategy_dhcp_pr_20220922_exp_iteration_23_1': dhcp_strategies.DecompTestStrategyDHCP_PR_20220922_exp_iteration_23_1,
        'test_strategy_dhcp_20220922_exp_iteration_23_1': dhcp_strategies.DecompTestStrategyDHCP_20220922_exp_iteration_23_1,
        'test_strategy_dhch_pr_20220922_exp_iteration_23_1': dhch_strategies.DecompTestStrategyDHCH_PR_20220922_exp_iteration_23_1,
...
class QueryOrderingSelector:
    query_orderings = {
        'decomp_test_strategy_regular_ordering'             : SingleStateDecompTestStrategyRegularOrdering,
        ...
        'DHCH_ordering': dhch_strategies.SingleStateTestStrategyRegularOrdering,
        'DHCH_ordering_full_tenure': dhch_strategies.SingleStateTestStrategyRegularOrderingFullTenure,
        'decomp_test_strategy_regular_ordering_dhch': dhch_strategies.DecompTestStrategyRegularOrderingDHCH,
        'DHCP_ordering': dhcp_strategies.SingleStateTestStrategyRegularOrdering,
        'decomp_test_strategy_regular_ordering_dhcp' : dhcp_strategies.DecompTestStrategyRegularOrderingDHCP,

        'test_strategy_regular_ordering_dhch_20220217_omitRelative': dhch_strategies.DecompTestStrategyRegularOrderingDHCH_20220217_omit_with_relative,
        'test_strategy_regular_ordering_dhch_20220323_pt1': dhch_strategies.DecompTestStrategyRegularOrderingDHCH_20220323_pt1,
        'test_strategy_regular_ordering_dhch_20220323_pt2': dhch_strategies.DecompTestStrategyRegularOrderingDHCH_20220323_pt2,
        'test_strategy_regular_ordering_dhch_20220323_pt3': dhch_strategies.DecompTestStrategyRegularOrderingDHCH_20220323_pt3,
        'test_strategy_regular_ordering_dhch_20220613_pt3': dhch_strategies.DecompTestStrategyRegularOrderingDHCH_20220613_pt3,
        'test_strategy_regular_ordering_dhch_20220623': dhch_strategies.DecompTestStrategyRegularOrderingDHCH_20220623,

        'test_strategy_regular_ordering_dhcp_20220310' : dhcp_strategies.DecompTestStrategyRegularOrderingDHCP_20220310,
        'test_strategy_regular_ordering_dhcp_20220413' : dhcp_strategies.DecompTestStrategyRegularOrderingDHCP_20220413,
        'test_strategy_regular_ordering_dhcp_20220511' : dhcp_strategies.DecompTestStrategyRegularOrderingDHCP_20220511,
        'test_strategy_regular_ordering_dhcp_20220518' : dhcp_strategies.DecompTestStrategyRegularOrderingDHCP_20220518,
        'test_strategy_regular_ordering_dhcp_20220811_exp_21_1': dhcp_strategies.DecompTestStrategyRegularOrderingDHCP_20220811_exp_21_1,

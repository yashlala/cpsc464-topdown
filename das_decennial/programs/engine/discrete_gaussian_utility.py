...
# Last modified by Some Human. 8/4/2021. Removed RationalBernolli and RationalDiscreteUniform, inlining appropriate rng.integer calls. Removed application of limit_denominator to sigma_sq
# Last modified by Some Human. 29/3/2021. Removed RationalBernolliExpFactors implementation
# Last modified by Some Human. 15/1/2021. RationalBernolliExpFactors implementation
# Last modified by Some Human. 11/3/2020. Shortcuts for Fraction arithmetic via integers.
# Last modified by P. Some Human. Module contains an exact/rational implementation

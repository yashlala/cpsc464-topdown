...
class OptimizationQueryOrdering(AbstractDASModule):
    ...
    def __init__(self, budget, schema, unit_hist_shape, **kwargs) -> None:
    ...
    def setOptimizersAndQueryOrderings(self, levels: List):
        """
        ...
        seq_opt_name = self.getconfig(CC.SEQ_OPT_OPTIMIZATION_APPROACH, section=CC.GUROBI_SECTION, default=CC.L2_PLUS_ROUNDER)
        outer_pass = seq_opt_name == CC.L2_PLUS_ROUNDER_INTERLEAVED
    ...
    def makeOptQueries(self, dp_geounit_node: GeounitNode) -> GeounitNode:
        """

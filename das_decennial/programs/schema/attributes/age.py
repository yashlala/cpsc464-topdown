...
class AgeAttr(AbstractAttribute):
    ...
    def recodeRange_agecats():
        """
        Create the hierarchical age categories requested by <xl_flag>Phil (8/8). These are for the 'range' queries.
        """
    ...
    def recodeBinarysplit_agecats(maxage=115, splitlist=None):
        """
        Create the hierarchical age categories requested initially by <xl_flag>Phil (8/7). These are for the 'binary split' queries.
